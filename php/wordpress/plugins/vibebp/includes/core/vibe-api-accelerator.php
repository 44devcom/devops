        ...
        if (strpos( $_SERVER['REQUEST_URI'], 'wp-json') != false){
            ...
            $api_url_list = [
                ...
                'wplms/v2'=>[
                    ...
                    'student\/courses'=>['buddypress/bp-loader.php','vibebp/loader.php','wplms_plugin/loader.php'],
                    'student\/badges'=>['buddypress/bp-loader.php','vibebp/loader.php','wplms_plugin/loader.php'],
                    'student\/certificates'=>['buddypress/bp-loader.php','vibebp/loader.php','wplms_plugin/loader.php','wplms-pdf-certificates/wplms-pdf-certificates.php'],
                    'student\/finishedCourses'=>['buddypress/bp-loader.php','vibebp/loader.php','wplms_plugin/loader.php'],
                    'student\/quiz'=>['buddypress/bp-loader.php','vibebp/loader.php','wplms_plugin/loader.php'],
                    'instructor\/courses\?args'=>['buddypress/bp-loader.php','vibebp/loader.php','wplms_plugin/loader.php'],
                    'instructor\/courses\/members\/\d+\/'=>['buddypress/bp-loader.php','vibebp/loader.php','wplms_plugin/loader.php'],
                    'instructor\/course\/\d+\/activity'=>['buddypress/bp-loader.php','vibebp/loader.php','wplms_plugin/loader.php'],
                    'instructor\/quizzes'=>['buddypress/bp-loader.php','vibebp/loader.php','wplms_plugin/loader.php'],
                    'instructor\/assignments'=>['buddypress/bp-loader.php','vibebp/loader.php','wplms_plugin/loader.php'],
                    'instructor\/manageStudents'=>['buddypress/bp-loader.php','vibebp/loader.php','wplms_plugin/loader.php'],
                    'instructor\/questions'=>['buddypress/bp-loader.php','vibebp/loader.php','wplms_plugin/loader.php'],
                    'instructor\/get_posts\/course'=>['buddypress/bp-loader.php','vibebp/loader.php','wplms_plugin/loader.php'],
                    'createElement'=>['buddypress/bp-loader.php','vibebp/loader.php','wplms_plugin/loader.php','woocommerce/woocommerce.php']
                ],
                'vibehd/v1'=>[
