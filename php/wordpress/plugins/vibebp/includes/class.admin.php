	...
	function get_addons(){
		$this->addons = apply_filters('vibebp_addons',array(
			...
			'vibe-stripe-payouts'=>array(
                ...
                'sub'=> __('Send payouts to instructor bank accounts via Stripe.','vibebp'),
                'icon'=> '<span class="dashicons dashicons-portfolio"></span>',
                'requires'=> '',
                'license_key'=>'vibe_stripe_payouts_license_key',
                'link' => 'https://wplms.io/downloads/vibe-stripe-payouts',
                'extra'=>array('Commission Payouts','Stripe Connect'),
                'activated'=> true,
                'price'=>'$29',
                'included'=>1,
                'tag'=>array('label'=>'Paid','class'=>'external'),
            ...
            'vibe-razorpay-payouts'=>array(
                ...
                'sub'=> __('Send payouts to instructor bank accounts via RazorPay.','vibebp'),
                'icon'=> '<span class="dashicons dashicons-portfolio"></span>',
                'requires'=> '',
                'license_key'=>'vibe_razorpay_payouts_license_key',
                'link' => 'https://wplms.io/downloads/vibe-razorpay-payouts',
                'extra'=>array('Commission Payouts','RazorPay Connect'),
                'activated'=> true,
                'price'=>'$29',
                'included'=>1,
                'tag'=>array('label'=>'Paid','class'=>'external'),
