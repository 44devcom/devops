	...
	function vibebp_general_settings(){
		...
		switch($sub){
			...
			$settings = apply_filters('vibebp_general_settings',array(
					...
					array(
						'label' => __('Use Application Passwords','vibebp'),
						'name' => 'wp_application_pwd',
						'type' => 'checkbox',
						'desc' => __('Use WP Application passwords instead of WP User Passwords.','vibebp'),
						'default'=>''
					),
					array(
