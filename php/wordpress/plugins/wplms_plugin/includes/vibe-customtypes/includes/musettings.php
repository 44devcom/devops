	...
	function lms_general_settings(){
		...
		switch($_GET['sub']){
			...
			default:
				...
				array(
						'label' => __('Show Course Directory in Vibe App','wplms'),
						'name' =>'show_course_directory',
						'class' => '',
						'type' => 'checkbox',
						'desc' => __('Show Course directory in app','wplms') 
					),
				array(
	...
	*/
	...
	function live(){
		...
		switch($_GET['sub']){
			...
			default:
				if(is_admin()){
					$function_name = apply_filters('lms_live_settings_tab',esc_attr($_GET['sub']));

					if(!empty($_GET['sub']) && function_exists($function_name) && esc_attr($_GET['sub']) != 'addons'){
						$function_name();
					}else{
						$this->live_addons();
					}
	...
	function get_addons(){
		return apply_filters('wplms_lms_addons',array(
			'wplms-coinstructors' =>array(
					'label'=> __('Wplms Co-instructors','wplms'),
					'sub'=> __('Adds co instructors with various levels of capabilities','wplms'),
					'icon'=> '<span class="dashicons dashicons-businessman"></span>',
					'requires'=> '',
					'license_key'=>'wplms_coi_license_key',
					'link' => ' https://wplms.io/downloads/wplms-coinstructors/',
					'extra'=>array('Add co instructor with various leve of capability'),
					'activated'=> (is_plugin_active('wplms-coinstructors/loader.php')?true:false),
					'file'=>'wplms-coinstructors/loader.php',
					'price'=>'FREE',
					'class'=>'featured'
				),

			'wplms-ai-qa' =>array(
					'label'=> __('AI Question & Answers','wplms'),
					'sub'=> __('Answer questions through Ai','wplms'),
					'icon'=> '<span class="dashicons dashicons-portfolio"></span>',
					'requires'=> '',
					'license_key'=>'wplms_ai_qa_license_key',
					'link' => ' https://wplms.io/downloads/wplms-ai-qa/',
					'extra'=>array('Answers questions from Ai'),
					'activated'=> (is_plugin_active('wplms-ai-qa/loader.php')?true:false),
					'file'=>'wplms-ai-qa/loader.php',
					'price'=>'BUY $19',
					'class'=>'featured'
				),
			'wplms-ai-quiz' =>array(
					'label'=> __('WPLMS Ai Quiz','wplms'),
					'sub'=> __('Generate quiz via AI','wplms'),
					'icon'=> '<span class="dashicons dashicons-portfolio"></span>',
					'requires'=> '',
					'license_key'=>'wplms_ai_quiz_license_key',
					'link' => ' https://wplms.io/downloads/wplms-ai-quiz/',
					'extra'=>array('Generate whole quiz from AI','Questions in quiz generated from AI'),
					'activated'=> (is_plugin_active('wplms-ai-quiz/loader.php')?true:false),
					'file'=>'wplms-ai-quiz/loader.php',
					'price'=>'BUY $19',
					'class'=>'featured'
				),
			'wplms-ai-questions-generator' =>array(
					'label'=> __(' AI Questions generator','wplms'),
					'sub'=> __('Generate questions via AI','wplms'),
					'icon'=> '<span class="dashicons dashicons-portfolio"></span>',
					'requires'=> '',
					'license_key'=>'wplms_ai_questions_generator_license_key',
					'link' => ' https://wplms.io/downloads/ai-questions-generator/',
					'extra'=>array('Generate questions from AI','Questions from Units'),
					'activated'=> (is_plugin_active('wplms-ai-questions-generator/loader.php')?true:false),
					'file'=>'wplms-ai-questions-generator/loader.php',
					'price'=>'BUY $19',
					'class'=>'featured'
				),
